...
const UploadBox = ({ pk_invoice_id, invoice, modal, profile }) => {
  const { modalUploadDispatch, invoiceDispatch, userState, userDispatch, userLoginState } = useContext(ContextStore);
  ...
  const handleSubmitInvoice = ({ pk_invoice_id, transactionStatus, payment_image }, e) => {
    e.preventDefault()
      ...
      >
        {profile && (
          <ModalBox profile={profile}>
            <img src={reviewImageUser === null ? process.env.PUBLIC_URL + `/images/user_image/${userLoginState.picture}` : reviewImageUser} alt='' />
            ...
            <ModalBox>
              ...
              <div>
                ...
                <Button
                  ...
                  bgColor={colors.green}
                  onClick={(e) =>
                    handleSubmitInvoice({ pk_invoice_id, transactionStatus, payment_image }, e)
                  }
                />
              </div>
            </ModalBox>
