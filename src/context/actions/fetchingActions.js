...
export const getUser = () => async (dispatch) => {
  const res = await axios.get("http://localhost:8081/input/user/1");
...
export const getCmsTransactions = () => async (dispatch) => {
  const res = await axios.get(
    "http://localhost:8081/input/order_get_all_datas"
  );
...
export const getPlants = () => async (dispatch) => {
  const res = await axios.get(
    "http://localhost:8081/input/plant_get_all_datas"
  );
...
export const getPlantById = (match) => async (dispatch) => {
  const res = await axios.get(
    `http://localhost:8081/input/plant_get_by_id/${match}`
  );
...
export const addCart = (data, phase, setNotif) => async (dispatch) => {
  ...
  const res = await axios.post("http://localhost:8081/input/cart", body, {
    headers: {
...
export const getCarts = (userLoginState) => async (dispatch) => {
  const res = await axios.get(
    `http://localhost:8081/input/cart/user/${userLoginState.pk_user_id}`
  );
...
export const deleteCart = (id) => async (dispatch) => {
  const res = await axios.delete(
    `http://localhost:8081/input/cart/delete/${id}`
  );
...
export const incrementCart = (data) => async (dispatch) => {
  const res = await axios.put(`http://localhost:8081/input/cart/update`, data);
...
export const cartCheckout = (data) => async (dispatch) => {
  const res = await axios.put(
    `http://localhost:8081/input/cart/checkout`,
    data
  );
...
export const cartUpdateReviewBtn = (data) => async (dispatch) => {
  const res = await axios.put(
    `http://localhost:8081/input/cart/reviewed`,
    data
  );
...
export const getAddresses = (userLoginState) => async (dispatch) => {
  const res = await axios.get(
    `http://localhost:8081/input/address/${userLoginState.pk_user_id}`
  );
...
export const createAddress = (data) => async (dispatch) => {
  ...
  const res = await axios.post(
    "http://localhost:8081/input/contact_input",
    body,
    {
      headers: {
        "content-type": "multipart/form-data",
...
export const getBanks = () => async (dispatch) => {
  const res = await axios.get("http://localhost:8081/input/bank");
...
export const getTransactions = (match) => async (dispatch) => {
  const res = await axios.get(
    `http://localhost:8081/input/transaction/${match.params.id}`
  );
...
export const getInvoices = () => async (dispatch) => {
  const res = await axios.get("http://localhost:8081/input/invoice");
...
export const getInvoiceDetails = (match) => async (dispatch) => {
  try {
    const res = await axios.get(
      `http://localhost:8081/input/invoice/${match.params.id}/${match.params.order}`
    );
...
export const createInvoice = (data) => async (dispatch) => {
  ...
  const res = await axios.post("http://localhost:8081/input/invoice", body, {
    headers: {
      "content-type": "multipart/form-data",
    },
  });
...
export const updateStatusTransaction = (data) => async (dispatch) => {
  ...
  const res = await axios.put("http://localhost:8081/input/invoice_update", {
    status,
    pk_invoice_id,
    payment_image,
  });
...
export const getReviews = (match) => async (dispatch) => {
  const res = await axios.get(`http://localhost:8081/input/review/${match}`);
...
export const reviewPost = (data) => async (dispatch) => {
  ...
  const res = await axios.post("http://localhost:8081/input/review", body, {
    headers: {
      "content-type": "multipart/form-data",
    },
  });
...
export const getArticles = () => async (dispatch) => {
  const res = await axios.get(
    "http://localhost:8081/input/article_get_all_datas"
  );
...
export const getArticleById = (match) => async (dispatch) => {
  const res = await axios.get(
    `http://localhost:8081/input/article_get_by_id/${match.params.id}`
  );
